    ...
    >
      ...
      <div style={{ maxWidth: '940px', margin: '0 auto', padding: '0 24px', position: 'relative', zIndex: 2, textAlign: 'center' }}>
        ...
        <div
          ref={phoneScrollRef}
          style={{
            /* seed: matches progress=0 so there's no jump on first update */
        ...
        >
          {/* Caption */}
          <p style={{ fontSize: '14px', fontWeight: 700, color: '#ffffff', textAlign: 'center', marginBottom: '18px', letterSpacing: '0.5px' }}>Real practices. Real numbers.</p>

          {/* Continuous floating loop — CSS keyframes, isolated from scroll transform */}
